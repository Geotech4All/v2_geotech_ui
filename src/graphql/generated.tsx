...
export type MostListenedToPodcastsQuery = {
  __typename?: "Query";
...
export function useMostListenedToPodcastsQuery(
  options?: Omit<
    Urql.UseQueryArgs<MostListenedToPodcastsQueryVariables>,
    "query"
  >,
) {
  return Urql.useQuery<
    MostListenedToPodcastsQuery,
    MostListenedToPodcastsQueryVariables
  >({ query: MostListenedToPodcastsDocument, ...options });
}
