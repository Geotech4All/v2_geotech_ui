...
export function useCreateUpdateTagMutation() {
  return Urql.useMutation<
    ...
    CreateUpdateTagMutationVariables
  >(CreateUpdateTagDocument);
}
export const CreateUpdateOrganizationDocument = gql`
  mutation CreateUpdateOrganization(
    $description: String
    $logoId: ID
    $name: String
    $organizationId: ID
