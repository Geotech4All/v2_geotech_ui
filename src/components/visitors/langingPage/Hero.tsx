  ...
  return (
    <header className="relative flex flex-col justify-center md:grid md:grid-cols-2 items-center justify-items-center z-0">
      ...
      <div className="flex-1">
        <div className="flex flex-col gap-4 p-5">
          <h1 className="text-4xl font-medium">
            Redefining{" "}
            <span className="font-extrabold md:text-7xl text-4xl">Geology</span>
            {" "}
            with
            <br />
            <span className="font-extrabold md:text-8xl text-4xl">
              Technology
            </span>
          </h1>
          <Link
            ...
            rounded transition-all duration-500 hover:rounded-[4rem] hover:pr-16 p-2 px-4 w-fit items-center`}
            href="/about"
          >
      ...
      <div className="flex flex-col z-0 relative w-fit items-baseline">
        <div className="md:aspect-square z-0 w-full md:translate-y-32">
          <Image
            width="1000"
            height="600"
            src="/laptop_map.png"
